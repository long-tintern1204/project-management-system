...
| :--- | :--- | :--- | :--- |
| 👑 **Long** <br>*(Trưởng nhóm)* | **1. `ログイン画面-UI確認`** | Màn hình Đăng nhập (`/login`) | - Giao diện form đăng nhập, placeholder.<br>- Validate bỏ trống email/password.<br>- Đăng nhập thành công (200) $\rightarrow$ lưu JWT token, redirect `/projects`.<br>- Đăng nhập thất bại (401) $\rightarrow$ thông báo tiếng Nhật. |
